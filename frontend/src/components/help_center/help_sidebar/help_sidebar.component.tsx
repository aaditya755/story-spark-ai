            ...
            <button
              ...
              className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${
                activeSection === section.id
                  ? "bg-blue-50 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300 border-l-2 border-blue-600 dark:border-blue-500 font-medium"
                  : "text-slate-600 dark:text-gray-400 hover:text-slate-900 dark:hover:text-gray-200 hover:bg-slate-50 dark:hover:bg-white/5"
              }`}
          ...
          {HELP_SECTIONS.map((section) => (
            <button
              ...
              className={`flex-shrink-0 px-4 py-2 rounded-full text-sm transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${
                activeSection === section.id
                  ? "bg-blue-100 dark:bg-blue-500/30 text-blue-700 dark:text-blue-200 border border-blue-300 dark:border-blue-500/40 font-medium"
                  : "bg-slate-50 dark:bg-white/5 text-slate-600 dark:text-gray-400 border border-slate-200 dark:border-white/10 hover:bg-slate-100 dark:hover:bg-white/10"
              }`}
              aria-current={activeSection === section.id ? "true" : undefined}
            >
              {section.label}
